module ContentApiHelpers
  def stub_content_api
    ...
    allow(content_api).to receive(:tag).with("oil-and-gas/licensing", "specialist_sector").and_return({
    ...
    allow(content_api).to receive(:with_tag).with("oil-and-gas/licensing", "specialist_sector").and_return({
